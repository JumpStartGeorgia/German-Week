...
set :application, "German-Week-Staging" # unique name of application
set :user, "germanweek-staging" # name of user on server
...
set :github_repo_name, "German-Week" # name of git hub repo
set :git_branch_name, "capistrano" # name of branch to deploy
